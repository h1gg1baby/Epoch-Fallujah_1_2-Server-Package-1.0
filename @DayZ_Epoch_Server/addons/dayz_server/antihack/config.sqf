...
["", "11111111111111111", true, false, true, ""],
["", "99999999999999999", true, false, true, ""]
...
local _dtext = "epoch.bplaced.net"; //---This text will appear at the bottom of the debug monitor
...
local _escTopT = "Lenny`s Epoch"; //---Text at the top of the escape menu
...
local _escLUPT = "Lenny`s Epoch"; //---Lower-upper text of the escape menu
local _escLUPC = [1,1,1,1]; //---Color of the lower-upper text of the escape menu

local _escLBOT = "Have fun!"; //---Lower-bottom text of the escape menu
...
local _missionFiles = ["configVariables.sqf","description.ext","init.sqf","mission.sqm","rules.sqf","dayz_code\init\compiles.sqf","dayz_code\init\variables.sqf"];
