call compile preprocessFileLineNumbers "\z\addons\dayz_server\trader_map\fallujah_trader_east.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\trader_map\fallujah_trader_city.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\trader_map\fallujah_trader_bandit.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\trader_map\fallujah_trader_hero.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\trader_map\fallujah_trader_wholesaler.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\trader_map\fallujah_trader_air.sqf";

call compile preprocessFileLineNumbers "\z\addons\dayz_server\sector_fob\sector_fob_loot.sqf";
