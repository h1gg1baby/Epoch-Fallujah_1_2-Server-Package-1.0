...
wai_user_spawnpoints = true; // setting this to true will disable the dynamic mission spawning system and enable server owners to define their own mission spawn points in WAI\configs\spawnpoints.sqf.
...
wai_avoid_safezones		= 550; // avoid spawning missions this close to safezones
