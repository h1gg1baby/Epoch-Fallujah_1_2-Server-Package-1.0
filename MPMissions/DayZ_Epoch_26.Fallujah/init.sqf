...
DZE_SafeZonePosArray = [[[8367.1055, 3287.554,0],100],[[3607.7407, 5392.4067,0],100],[[8478.0957,1428.9974,0],100],[[2044.6136, 6630.6401,0],100],[[3520.7532, 2697.9312,0],100],[[8167.1143, 7322.7173,0],100]]; // Format is [[[3D POS],RADIUS],[[3D POS],RADIUS]]; Stops loot and zed spawn, salvage and players being killed if their vehicle is destroyed in these zones.
...
//    call compile preprocessFileLineNumbers "dayz_code\system\mission\fallujah.sqf"; //Add trader city objects locally on every machine early
initialized = true;
...
if (isServer) then {
    ...
    execVM "\z\addons\dayz_server\traders\fallujah.sqf"; //Add trader agents
...
if (!isDedicated) then {
    call compile preprocessFileLineNumbers "dayz_code\system\mission\server_traders\fallujah.sqf";
