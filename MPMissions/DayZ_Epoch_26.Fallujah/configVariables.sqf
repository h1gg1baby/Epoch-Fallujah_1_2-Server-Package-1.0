...
Z_VehicleDistance = 100; // Max distance a vehicle can be sold or accessed from at a trader.
...
if (isServer) then {
	...
	MaxVehicleLimit = 75; // Max number of random vehicles to spawn around the map
...
if (!isDedicated) then {
	...
	dayz_paraSpawn = true; // Helo jump spawn
	...
	DZE_BuildingLimit = 550; // Maximum allowed objects per plot
